...
class ActorCritic(nn.Module):
    def __init__(self, input_shape, num_actions):
        ...
        self.conv1 = init_(nn.Conv2d(input_shape[0], 32, kernel_size=2, stride=2))
        self.conv2 = init_(nn.Conv2d(32, 64, kernel_size=2, stride=2))
        self.conv3 = init_(nn.Conv2d(64, 32, kernel_size=1, stride=1))
